  ...
  <div class="row">
    ...
    <?php include "./templates/sidebar.php"; ?>
      ...
      <div class="row">
      	...
      	<div class="col-2">
      		<a href="#" data-toggle="modal" data-target="#add_category_modal" class="btn btn-primary btn-sm">Add Location</a>
      	</div>
      </div>
      ...
      <div class="modal-body">
        <form id="add-category-form" enctype="multipart/form-data">
        	<div class="row">
        		...
        		<div class="col-12">
        			<button type="button" class="btn btn-primary add-category" id="add_category_btn">Add Location</button>
        		</div>
        	</div>
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="form-group">
                ...
                <input type="text" name="cat_name" class="form-control" placeholder="Enter Location Name">
              </div>
            </div>
            <input type="hidden" name="updatebutton" value="1">
            <div class="col-12">
              <button type="button" class="btn btn-primary edit-category-btn">Update Location</button>
            </div>
          </div>
